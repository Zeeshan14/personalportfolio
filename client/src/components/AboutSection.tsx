...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-20 bg-white" ref={elementRef}>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className={`scroll-animate-left ${isVisible ? 'animate' : ''}`}>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className={`text-center p-4 stagger-animate stagger-1 ${isVisible ? 'animate' : ''}`}>
                <div className="text-3xl font-bold text-blue-600">5+</div>
                <div className="text-slate-600">Years Experience</div>
              </div>
              <div className={`text-center p-4 stagger-animate stagger-2 ${isVisible ? 'animate' : ''}`}>
                <div className="text-3xl font-bold text-blue-600">15+</div>
                <div className="text-slate-600">Projects Completed</div>
              </div>
              <div className={`text-center p-4 stagger-animate stagger-3 ${isVisible ? 'animate' : ''}`}>
                <div className="text-3xl font-bold text-blue-600">99.9%</div>
                <div className="text-slate-600">System Uptime</div>
              </div>
              <div className={`text-center p-4 stagger-animate stagger-4 ${isVisible ? 'animate' : ''}`}>
          ...
          <div className={`space-y-6 scroll-animate-right ${isVisible ? 'animate' : ''}`}>
            <img 
